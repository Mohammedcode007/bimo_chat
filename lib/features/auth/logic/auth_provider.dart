    ...
    _sub = ws.stream.listen((data) {
      ...
      */
      ...
      /*
        ...
        الاثنين يحدثوا user فقط بدون ما يعملوا login جديد
      */
      if (handler == WsEvents.userProfileEvent ||
        ...
        if (type == 'success') {
          ...
          state = state.copyWith(
            ...
            // مهم: لا تجعل تعديل البروفايل كأنه login جديد
            loggedIn: state.loggedIn,
      ...
      /*
        حذف الحساب
        بعد نجاح الحذف نمسح حالة المستخدم محليًا
        وصفحة الإعدادات سترجع Login لأنها تراقب loggedIn
      */
